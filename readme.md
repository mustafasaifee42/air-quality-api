...
Example Request URL 
`/list/cities?country=United States of America`
...
`/air-quality/hourly-data/{countryID}?startDate={startDate}&endDate={endDate}`
...
| Parameter     | Type          | Description  | Compulsary |
| ------------- | ------------- | ------------ | ---------- |
| startDate | string | Data is fetched starting from this date. __Format: `YYYY-MM-DD`__ | true |
| endDate | string | Data is fetched till this date (this date not included). __Format: `YYYY-MM-DD`__ | true |

Example Request URL
`/air-quality/hourly-data/United_States_of_America?startDate=2020-01-01&endDate=2020-02-01`
...
`/air-quality/hourly-data/{countryID}/{regionID}/{cityID}?startDate={startDate}&endDate={endDate}`
...
Example Request URL
`/air-quality/hourly-data/United_States_of_America/New_York/New_York_City?startDate=2020-01-01&endDate=2020-02-01`
...
`/air-quality/daily-average/{countryID}?startDate={startDate}&endDate={endDate}`
...
Example Request URL
`/air-quality/daily-average/United_States_of_America?startDate=2020-01-01&endDate=2020-02-01`
...
`/air-quality/daily-average/{countryID}/{regionID}/{cityID}?startDate={startDate}&endDate={endDate}`
...
Example Request URL
`/air-quality/daily-average/United_States_of_America/New_York/New_York_City?startDate=2020-01-01&endDate=2020-02-01`
...
`/air-quality/monthly-average/{countryID}?startDate={startDate}&endDate={endDate}`
...
| Parameter     | Type          | Description  | Compulsary |
| ------------- | ------------- | ------------ | ---------- |
| startDate | string | Data is fetched starting from this date. __Format: `YYYY-MM`__ | true |
| endDate | string | Data is fetched till this date (this date not included). __Format: `YYYY-MM`__ | true |

Example Request URL
`/air-quality/monthly-average/United_States_of_America?startDate=2020-01-01&endDate=2020-02-01`
...
`/air-quality/monthly-average/{countryID}/{regionID}/{cityID}?startDate={startDate}&endDate={endDate}`
...
Example Request URL
`/air-quality/monthly-average/United_States_of_America/New_York/New_York_City?startDate=2019-01&endDate=2020--01`
